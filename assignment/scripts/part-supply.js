...
for(let i = 0; i < supplyChanges.length; i++){
    ...
    if(supplyChanges[i]>0) {
        console.log(supplyChanges[i] + 'Added x parts');
    }
    else if(supplyChanges[i]<0) {
        console.log(supplyChanges[i] + 'Removed x parts');
...
for(let num of supplyChanges){
    console.log(num);
    if(num > 0) {
        console.log(num + 'Added x parts');
    
    }
    else if(num < 0){
        console.log(num + 'Removed x parts');
    }
    else{
